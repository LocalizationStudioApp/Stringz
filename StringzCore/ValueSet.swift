...
extension ValueSet {
    ...
    public func setOrAppend(value: String, for language: Language) {
    ...
    /// - Parameter value: The new value to be set.
    /// - Parameter language: The language of the value.
    public func set(value: String, for language: Language) {
        if let val = self.value(for: language) {
            val.value = value
        }
    }
    ...
    /// - Parameter language: The language of the value.
    public func set(originalIndex: Int?, for language: Language) {
        if let val = value(for: language) {
    ...
    /// - Parameter language: The language of the value.
    public func set(variableName: String?, for language: Language) {
        if let val = value(for: language) {
    ...
    public var availableLanguages: [Language] {
        return values.map { $0.language }.uniqued()
    }
}
...
extension Array where Element == ValueSet {
    ...
    public mutating func setOrAppend(value: String, for key: String, and language: Language) -> ValueSet {
        var valueSet = first(where: { $0.key == key })
    ...
    /// - Parameter key: The key of the value set.
    /// - Parameter language: The language of the value.
    public mutating func set(value: String, for key: String, and language: Language) {
        if let valueSet = valueSet(for: key) {
    ...
    /// - Parameter key: The key of the value set.
    public mutating func set(comment: String, for key: String) {
        if let valueSet = valueSet(for: key) {
    ...
    /// - Parameter key: The key of the value set.
    /// - Parameter language: The language of the value.
    public mutating func set(originalIndex: Int?, for key: String, and language: Language) {
        if let valueSet = valueSet(for: key) {
    ...
    /// - Parameter key: The key of the value set.
    /// - Parameter language: The language of the value.
    public mutating func set(variableName: String?, for key: String, and language: Language) {
        if let valueSet = valueSet(for: key) {
...
//    return self.first(where: { $0.key == key })?.comment
    ...
    public func valueSet(for key: String) -> ValueSet? {
        return first(where: { $0.key == key })
    }

    /// Returns all available languages in current value set array
    public var availableLanguages: [Language] {
        return flatMap { $0.availableLanguages }.uniqued()
    }
}
