...
class EditorViewController: NSViewController {
    ...
    @IBOutlet var containerEmpty: NSStackView!
    @IBOutlet var labelEmpty: NSTextField!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        addObserver(self, forKeyPath: "view.window.windowController", options: .new, context: nil)
    }
...
//            print(column.dataCell)
        ...
        tableView.sortDescriptors = windowController.editorManager.sortDescriptors
...
extension EditorViewController: NSTableViewDataSource, NSTableViewDelegate {
    ...
    func tableView(_ tableView: NSTableView, sortDescriptorsDidChange oldDescriptors: [NSSortDescriptor]) {
        ...
        windowController.editorManager.sortDescriptorsDebouncer.call(userInfo: tableView.sortDescriptors)
    }
    ...
    func tableView(_ tableView: NSTableView, shouldEdit tableColumn: NSTableColumn?, row: Int) -> Bool {
        guard let tableColumn = tableColumn, let localizable = windowController.selectedLocalizable else { return false }
        let identifier = tableColumn.identifier.rawValue
...
extension EditorViewController {
    ...
    @objc func userDefaultsDidChange(_ notification: Notification) {
        if showFlags != UserDefaults.generalShowFlags {
        ...
        if showKeyColumn != UserDefaults.showKeyColumn {
            DispatchQueue.main.async {
        ...
        if showCommentColumn != UserDefaults.showCommentColumn {
            DispatchQueue.main.async {
